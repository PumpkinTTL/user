      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 mb-16">
        ...
        <div>
          ...
          <div class="space-y-4">
            ...
            <!-- 微信（硬编码） -->
            <div
              class="flex items-center space-x-3 text-sm p-3 rounded-lg bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/5">
              <svg class="w-5 h-5 text-[#07C160] flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
